# DASHBOARD.md — 2026-02-16 00:20 KST

## 🎯 현재 프로젝트

### 스마트스토어 주문/송장 자동화 + 사장님 포털 (1순위)

> SmartStore 구현/자동화는 Opus 전담. Clo는 IG 자동운영/게시 직전 자동화 + Ops(감독/가드레일) 레이어에 집중.
...
- [x] (Insight) 사업모델=멀티 카테고리 리셀(유명 브랜드 저가 소싱, SKU 100+)
  - 성장 콘텐츠 축=딜/큐레이션/선택피로 해결(Top3/비교/피부타입 매칭)
  - 7일 운영안(하루 1포스트) 초안 + 저장형 캐러셀(Top3 딜) 원고 초안 작성
